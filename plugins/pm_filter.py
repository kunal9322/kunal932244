...
async def cb_handler(client: Client, query: CallbackQuery):
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('♥️ Love @little_little_hackur ♥️')
            else:
                await query.message.edit_text(
                    "I'm not connected to any groups!\nCheck /connections or connect to any groups",
                    quote=True
                )
                return await query.answer('♥️ Thank You @little_little_hackur ♥️')
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🔔 Updates 🤖', url='https://t.me/little_little_hackur')
        ], [
        ...
        await query.answer('♥️ Thank You @little_little_hackur ♥️')
...
async def advantage_spell_chok(msg):
    ...
    if not movielist:
        k = await msg.reply("Hey Sona! Mujhe is naam se koi movie nhi mili,\nMujhe lgta hai ki aapne spelling galat likh dii h 🤷‍♀️!\nPlease check your spelling once again 🤦‍♀️... or \n Discuss your problem with our admin here 👉 <a href='https://t.me/GoogleMovieRequest'>Discuss Here</a> ♥️ ")
        await asyncio.sleep(8)
        await k.delete()
        return
